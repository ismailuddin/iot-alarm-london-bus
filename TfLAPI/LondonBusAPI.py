...
class TfLBusArrivalsAPI:
	...
	def queryBusArrivals(self, **kwargs):
		"""
		Returns a sorted list of bus arrival times in minutes for 
		...
		$  tfl.queryBusArrivals(bus_line='205', bus_stop_code=48439)
		"""
